export default CS1=>{
  ...
  CS1.hud = {};
  CS1.hud.dial = new Dial(document.querySelector('#hud'));
  CS1.hud.dial.animateStart();
  setInterval(e=>{
   CS1.hud.dial.animateTo(100*Math.random());
  },4000);
  });
...
var Dial = function(container) {
    ...
    this.container.style.width = window.innerWidth/8 + 'px';
    this.container.style.height = window.innerWidth/8 + 'px';
...
Dial.prototype.animateTo = function(to) {
    var v = this.value;
    var self = this;
    var intervalOne = setInterval(function() {
